 ---
  Arquivo 1 — NOVO: src/components/FAQSection.tsx

  No GitHub: clica em src/components → botão "Add file" → "Create new file" → nomeia FAQSection.tsx → cola o código abaixo → Commit.
